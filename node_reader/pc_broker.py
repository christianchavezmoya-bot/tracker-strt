"""Embedded MQTT broker (Mosquitto-like) for PC — WiFi nodes publish here."""
...
from node_reader.capture_plugin import clear_message_handlers, register_message_handler
...
class PcMqttBroker:
    """Run amqtt broker on PC (default 0.0.0.0:1883)."""
    ...
    def start(self) -> tuple[bool, str]:
        ...
        self._thread = threading.Thread(target=run, daemon=True, name="PcMqttBroker")
        self._thread.start()
